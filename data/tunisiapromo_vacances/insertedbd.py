...
def inserer_ou_mettre_a_jour_vacances():
    ...
    print("📊 Fichier: vacances_final.json (69 annonces de locations de vacances)")
    ...
    if operations:
        ...
        batch_size = 50  # Lot plus petit car moins d'annonces
        total_insere = 0
        total_modifie = 0
