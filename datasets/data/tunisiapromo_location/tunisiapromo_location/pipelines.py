...
class TunisiapromoLocationPipeline:
    """Pipeline avec gestion incrémentale pour les locations"""

    def __init__(self):
        self.json_file = 'tunisiapromo_location.json'
        self.csv_file = 'tunisiapromo_location.csv'
    ...
    def close_spider(self, spider):
        ...
        # Compter correctement les inchangées
        # updated_annonces contient modifiées + inchangées déjà re-ajoutées
        nb_inchangees = sum(1 for a in self.updated_annonces if a.get('statut') == 'inchangé')
        self.stats['annonces_inchangees'] = nb_inchangees
    ...
    def print_report(self):
        print("\n" + "="*60)
        print("📊 RAPPORT TUNISIAPROMO LOCATION")
        print("="*60)
