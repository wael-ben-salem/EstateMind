...
class TunisiapromoPipeline:
    """Pipeline avec gestion incrémentale"""

    def __init__(self):
        self.json_file = 'tunisiapromo_vente.json'
        self.csv_file = 'tunisiapromo_vente.csv'
        self.stats_file = 'tunisiapromo_stats.json'
    ...
    def close_spider(self, spider):
        ...
        # compter correctement modifiées / inchangées
        ...
        # garder les anciennes jamais revues dans ce run
